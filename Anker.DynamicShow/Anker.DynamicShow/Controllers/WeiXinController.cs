...
namespace Anker.DynamicShow.Controllers
{
    public class WeiXinController : Controller
    {
        ...
        public ActionResult Post(PostModel postModel/*,[FromBody]string requestXml*/)
        {
            ...
            CustomMessageHandler messageHandler = new CustomMessageHandler(inputStream, postModel);
            //日志记录
            log.Info(string.Format("_getRandomFileName():{0}, messageHandler.RequestMessage.FromUserName:{1}", _getRandomFileName(),messageHandler.RequestMessage.FromUserName));
            //接收消息  
