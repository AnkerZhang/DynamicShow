        ...
        public override IResponseMessageBase OnTextRequest(RequestMessageText requestMessage)
        {
            ...
            var requestHandler =
                requestMessage.StartHandler()
                 .Keyword("关键字", () =>
                 {
                     responseMessage.Content = Service.LocationSercice.GetText("关键字");
                     return responseMessage;
                 }).Keywords(new[] { "我", "你" }, () =>
                 {
                     responseMessage.Content = Service.LocationSercice.GetText("我");
                     return responseMessage;
                 }).Keywords(new[] { "测试" }, () =>
                 {
                     responseMessage.Content = Service.LocationSercice.GetText("测试");
                     return responseMessage;
                 }).Keyword("异步", () =>
                 {
                     return responseMessage;
                 ...
                 {
                     responseMessage.Content = "点击打开：http://www.nbug.xin/WinXin/DemoHtml";
                     return responseMessage;
                 }).Default(() =>
                 {
